...
const ForacsetD = ({title, foracWeather}) => {
      ...
      <div className='foracsets'>
        ...
        <div className="flex flex-row items-center justify-between text-white slider-hourly">
          <div className='flex flex-col items-center justify-center '>
            <p className='fint-light text-sm'>{foracWeather.daily[1].day}</p>
            <img src={icons[foracWeather.daily[1].icon - 1]}
             alt=""
             className='w-12 my-1' />
             <p className='font-medium'>{foracWeather.daily[1].all_day.temperature}</p>
          </div>
          <div className='flex flex-col items-center justify-center '>
            <p className='fint-light text-sm'>{foracWeather.daily[2].day}</p>
            <img src={icons[foracWeather.daily[2].icon - 1]}
             alt=""
             className='w-12 my-1' />
             <p className='font-medium'>{foracWeather.daily[2].all_day.temperature}</p>
          </div>
          <div className='flex flex-col items-center justify-center '>
            <p className='fint-light text-sm'>{foracWeather.daily[3].day}</p>
            <img src={icons[foracWeather.daily[3].icon - 1]}
             alt=""
             className='w-12 my-1' />
             <p className='font-medium'>{foracWeather.daily[3].all_day.temperature}</p>
          </div>
          <div className='flex flex-col items-center justify-center '>
            <p className='fint-light text-sm'>{foracWeather.daily[4].day}</p>
            <img src={icons[foracWeather.daily[4].icon - 1]}
             alt=""
             className='w-12 my-1' />
             <p className='font-medium'>{foracWeather.daily[4].all_day.temperature}</p>
          </div>
          <div className='flex flex-col items-center justify-center '>
            <p className='fint-light text-sm'>{foracWeather.daily[5].day}</p>
            <img src={icons[foracWeather.daily[5].icon - 1]}
             alt=""
             className='w-12 my-1' />
             <p className='font-medium'>{foracWeather.daily[5].all_day.temperature}</p>
          </div>
        </div>
      </div>
    )
